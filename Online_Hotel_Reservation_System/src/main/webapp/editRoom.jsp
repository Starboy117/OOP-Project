  ...
  <body>
    ...
    <main class="mx-auto px-8 py-8 max-w-6xl">
      <div class="flex items-center mb-8">
        ...
        <h1 class="text-3xl font-bold text-primary">Edit Room #1024</h1>
      </div>
      <div class="bg-white rounded shadow-sm p-6 max-w-5xl">
        <form id="editRoomForm" class="space-y-6">
          ...
          <div>
            ...
            >
Luxurious deluxe room with city view, featuring modern amenities and elegant decor. Perfect for business travelers or couples seeking comfort and style.</textarea
            >
          </div>
            <div class="flex space-x-4">
              ...
              <button
                type="submit"
                class="px-6 py-2 bg-primary text-white rounded hover:bg-primary/90 !rounded-button whitespace-nowrap"
              >
                Update Room
              </button>
            </div>
    ...
    >
      <div class="bg-white rounded-lg p-6 max-w-md w-full">
        ...
        <p class="text-gray-600 text-center mb-6">
          Are you sure you want to delete Room #1024? This action cannot be
          undone.
        </p>
